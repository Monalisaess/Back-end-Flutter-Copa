...
def criar_partida(dados: dict) -> dict:
    ...
    cursor = bd.cursor()
    cursor.execute(
        "INSERT INTO partidas (data, placar_casa, placar_visitante, id_selecao_casa_fk, id_selecao_visitante_fk) VALUES (%s, %s, %s, %s, %s);",
        (data, placar_casa, placar_visitante, id_casa, id_visitante),
    )
    bd.commit()
